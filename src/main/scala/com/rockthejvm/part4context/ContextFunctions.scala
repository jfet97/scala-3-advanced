...
object ContextFunctions {
  ...
  // lambdas that take given arguments
  ...
  // val func2 = methodWithContextArguments // doesn't work because of the using clause
  ...
  // val incrementAsync: Int => Future[Int] = x => Future(x + 1) // doesn't work without a given EC in scope here (at definition)
